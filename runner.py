...
if __name__ == "__main__":
    ...
    print(eval.average_rank(top_k=len(bm25_index.contexts), expand_query=False, verbose=False, k_arg=2, alpha=2, uni_dict_list=unigram_list, bi_dict_list=bigram_list, tri_dict_list=trigram_list))
    # main idea: Get the top K docs, fetch the docs's query tagging
    # if tagging exist for the doc then yes
    # eval = Eval()
